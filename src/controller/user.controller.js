...
const createUser = async (req, res) => {
    ...
    let user = new User(null, req.body.name, req.body.last_name, req.body.email, req.body.photo, null);
    try{
        let sqlEmail = "SELECT email FROM user WHERE user.email = '" + user.email + "'";
        ...
        if(checkEmail.length){
            ...
            let sqlUser = "SELECT id_user FROM user WHERE user.email = '" + user.email + "'";
